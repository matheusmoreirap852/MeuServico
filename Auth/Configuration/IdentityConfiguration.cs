...
namespace ProjetoServicoWork.Auth.Configuration;
        ...
        new List<Client>
        {
               //cliente genérico
                ...
                new Client
                {
                    ...
                    RedirectUris = { "http://localhost:5247/signin-oidc" }, //login
                    PostLogoutRedirectUris = { "http://localhost:5247/signout-callback-oidc" }, //logout
