...
public class DatabaseIdentityServerInitializer : IDatabaseSeedInitializer
{
    ...
    public void InitializeSeedUsers()
    {
        ...
        if (_userManager.FindByEmailAsync("matheus@com.br").Result == null)
        {
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "matheus@com.br",
                NormalizedEmail = "MATHEUS@COM.BR",
                EmailConfirmed = true,
                LockoutEnabled = false,
                PhoneNumber = "+55 (11) 12345-6789",
                FirstName = "matheus",
            ...
            IdentityResult resultClient = _userManager.CreateAsync(client, "MTA944gl@").Result;
